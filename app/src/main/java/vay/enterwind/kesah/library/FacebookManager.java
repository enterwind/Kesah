...
public class FacebookManager {
    ...
    private Call<vay.enterwind.kesah.entities.AccessToken> call;
    ...
    private void getTokenFromBackend(String name, String email, String provider, String providerUserId){
        ...
        call.enqueue(new Callback<vay.enterwind.kesah.entities.AccessToken>() {
            @Override
            public void onResponse(Call<vay.enterwind.kesah.entities.AccessToken> call, Response<vay.enterwind.kesah.entities.AccessToken> response) {
            ...
            @Override
            public void onFailure(Call<vay.enterwind.kesah.entities.AccessToken> call, Throwable t) {
